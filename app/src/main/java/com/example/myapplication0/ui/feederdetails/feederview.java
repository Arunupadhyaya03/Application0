...
public class feederview extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String res="";
        try {
            res=new BackgroundWorker().execute("feederview").get();
            Log.v(TAG,"res      .."+res);
            JSONObject feederv = new JSONObject(res);
            JSONArray feederarray=feederv.getJSONArray("result");
            if(feederarray.length()!=0){
                ...
                for (int i = 0; i < feederarray.length(); i++){
                    ...
                    String feeder_no=(feeder.getString("feeder_no"));
                    String feeder_name = (feeder.getString("feeder_name"));
                    String type_of_conductor=(feeder.getString("type_of_conductor"));
                    String no_of_dtrs = (feeder.getString("no_of_dtrs"));
                    String total_length = (feeder.getString("total_length"));
                    String total_consumer = (feeder.getString("total_consumer"));
                    ...
                    tb1.setText(String.format("%.0f",Double.parseDouble(feeder_no)));
                    tb2.setText(feeder_name);
                    tb3.setText(type_of_conductor);
                    tb4.setText(String.format("%.2f",Double.parseDouble(no_of_dtrs)));
                    tb5.setText(String.format("%.0f",Double.parseDouble(total_length)));
                    tb6.setText(String.format("%.0f",Double.parseDouble(total_consumer)));
