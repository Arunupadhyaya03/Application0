...
public class MeterViewFragment extends Fragment {
 ...
 TableLayout table;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_meter_view, container, false);

        table = root.findViewById(R.id.table);
        Log.v("nda","Working Line11");
        String res="";
        try {
            res=new BackgroundWorker().execute("meterview").get();
            Log.v(TAG,"res      .."+res);
            JSONObject meterv = new JSONObject(res);
            JSONArray meterarray=meterv.getJSONArray("result");
            if(meterarray.length()!=0){
                ...
                tb1_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb2_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb3_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb4_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb5_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb6_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb7_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb8_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb9_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb10_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb11_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb12_head.setBackgroundColor(Color.parseColor("#1a686a"));
                tb13_head.setBackgroundColor(Color.parseColor("#1a686a"));
                ...
                tb1_head.setTextColor(Color.parseColor("#ffffff"));
                ...
                tb1_head.setText("User ID\n");
                tb2_head.setText("Meter Number\n");
                tb3_head.setText("Meter Name\n");
                tb4_head.setText("Installation date\n");
                tb5_head.setText("MF\n");
                tb6_head.setText("Initial Reading\n");
                ...
                for (int i = 0; i < meterarray.length(); i++){
                   ...
                   // String Meter=(subdivdata.getString("Meter"));
                    String user_id=(meter.getString("user_id"));
                    String meter_no = (meter.getString("meter_no"));
                    String meter_name=(meter.getString("meter_name"));
                    String date_of_install = (meter.getString("date_of_install"));
                    String mf = (meter.getString("mf"));
                    String initial_reading=(meter.getString("initial_reading"));
                    String no_of_display_digits=(meter.getString("no_of_display_digits"));
                    String type_of_meter=(meter.getString("type_of_meter"));
                    String accuracy=(meter.getString("accuracy"));
                    String make_name=(meter.getString("make_name"));
                    String protocol=(meter.getString("protocol"));
                    String installation_by=(meter.getString("installation_by"));
                    String status=(meter.getString("status"));
                    Log.v("nda","Cload2");
                    ...
                    tb1.setText(String.format("%.0f",Double.parseDouble(user_id)));
                    tb2.setText(String.format("%.0f",Double.parseDouble(meter_no)));
                    tb3.setText(meter_name);
                    tb4.setText(date_of_install);
                    tb5.setText(String.format("%.2f",Double.parseDouble(mf)));
                    tb6.setText(String.format("%.0f",Double.parseDouble(initial_reading)));
                    tb7.setText(String.format("%.0f",Double.parseDouble(no_of_display_digits)));
                    tb8.setText(type_of_meter);
                    tb9.setText(String.format("%.0f",Double.parseDouble(accuracy)));
                    tb10.setText(make_name);
                    tb11.setText(protocol);
                    tb12.setText(installation_by);
                    tb13.setText(status);
